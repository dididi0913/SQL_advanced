...
![alt text](<화면 캡처 2026-09-06 204509.png>)

## 02-2. 데이터베이스 시작부터 끝까지 
> **데이터베이스 만들기(68 ~ 71p)의 1~5과정 진행 후 과제 페이지에서 요구하는 인증사진을 첨부해주세요.**
![alt text](<화면 캡처 2026-09-06 205217.png>)

> **테이블 만들기(71 ~ 75p)의 1~7과정 진행 후 과제 페이지에서 요구하는 인증사진을 첨부해주세요.**
![alt text](<화면 캡처 2026-09-06 205846.png>)
![alt text](<화면 캡처 2026-09-06 210059.png>)

 
> **데이터 입력하기(75 ~ 79p)의 1~11과정 진행 후 과제 페이지에서 요구하는 인증사진을 첨부해주세요.**
![alt text](<화면 캡처 2026-09-06 210358.png>)
![alt text](<화면 캡처 2026-09-06 210532.png>)

> **데이터 활용하기(80 ~ 83p)의 1~6과정 진행 후 과제 페이지에서 요구하는 인증사진을 첨부해주세요.**

![alt text](<화면 캡처 2026-09-06 211314.png>)
